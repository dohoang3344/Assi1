        ...
        <div class=" container">
            <div class="row">
                <div class="col-8 m-auto">
                    <h1 class="mt-5"style="font-style: italic;font-family: 'Dancing Script', cursive;" align="center"> Thêm sản phẩm</h1><br>
                    <div class="row" style="">
                        <form class="login-form m-auto"  action="AddMoreProduct" method="post">
                            <div class="form-group">
                                <%if (product_name == null) {
                                        product_name = "";
                                    }%>
                                <label class="text-uppercase">Tên sản phẩm</label>
                                <input type="text" required placeholder="Nhập tên sản phẩm" class="form-control" name="product_name" value="<%=product_name%>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" placeholder="Mô tả sản phẩm"  name="detail" value="<%=product_image%>">
                            </div>
                            <div class="form-group">
                                <%if (guarantee == null) {
                                        guarantee = "";
                                ...
                                <input type="text" required class="form-control" placeholder="Chế độ bảo hành"  name="guarantee" value="<%=product_image%>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-check " style="margin-right: 60px;margin-top:20px" >
                                <button type="submit" class="btn btn-outline-dark float-right">Thêm mặt hàng</button>
                            </div>
                        </form>
                    </div>
